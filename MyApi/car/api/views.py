...
from .serializers import CarsSrializer
from ..models import Cars
from rest_framework.response import Response


class CarsAPIView(APIView):
    serializer_class = CarsSrializer
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            if id != None:
                ...
                serializer = CarsSrializer(car)
        except:
            cars = self.get_queryset()
            serializer = CarsSrializer(cars, many=True)
    ...
    def post(self, request, *args, **kwargs):
        ...
        new_car.save()
        serializer = CarsSrializer(new_car)
        return Response(serializer.data)
    ...
    def put(self, request, *args, **kwargs):
        ...
        serializer = CarsSrializer(car_object)
        return Response(serializer.data)
